...
export default class WelcomeOneScreen extends Component {
    ...
    callSecondWelcomeScreen = () => {
        Navigation.push(this.props.componentId, {
            component: {
              name: 'B21.WelcomeSecondScreen',
              passProps : {
    ...
    render() {
        return (
          <View style = { [ commonStyles.mainContainer, commonStyles.lightBlueBackground ] } >
            <View style = { [ commonStyles.subContainer,commonStyles.defaultPaddingLeftRight ] }>
                ...
                <Text 
                    ...
                    { strings('welcome.screenone_description') } 
                </Text>
                <View style = { [ commonStyles.alignChildCenter, commonStyles.flexDirectionRow ] } >
                    <View style = { [ commonStyles.smallCircle,commonStyles.tertiaryBackgroundColor ] } ></View>
                    <View style = { [ commonStyles.smallCircle,commonStyles.quarternaryBackgroundColor, commonStyles.marginLeft5 ] } ></View>
                </View>
             </View>
